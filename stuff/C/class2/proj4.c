...
int  make_lgrades(char lgrades[],int grades[],int n);

int main(void){

    //Variable Declarations
    int temp,i,sum=0,n=100,exit_loop=0,grades[100];
    float avg;
    char ch,lavg,lgrades[100];
    FILE *gradefile;
    ...
    if(make_lgrades(lgrades,grades,n))
    {
