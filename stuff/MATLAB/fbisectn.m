function [root,fval,err,iter] = fbisectn(func,xl,xu,err_min,n,varargin)
% fbisectn: bisection root locator with max iteration stopper
%   [root,fval,err,iter] = fbisectn(func,x1,xu,err_min,max_iter,fargin):
