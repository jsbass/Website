function [root,fval,err,iter] = ffalseposabs(func,xl,xu,err_min,n,varargin)
% ffalseposabs: false-position root locator with absolute error
%   [root,fval,err,iter] = ffalseposabs(func,x1,xu,err_min,max_iter,fargin):
