function [T,V,R,Temp,D] = potentiometer(a,inputPin,vSource,r0,r3)
% [T,V,R,Temp,D] = potentiometer(a,inputPin,vSource,r0)
% potentiometer(a,inputPin,vSource,r0) - opens a GUI for collecting data
% on a potentiometer using an arduino
...
switch(nargin)
    ...
    function [v,r,d,temp] = getData()
        ...
        v = vSource*d/(res-1);
        r = r0*d/(res-1)+r0;
        temp = 1/(A+B*log(r/r0)+C*log(r/r0)^2+D*log(r/r0)^3);
    end
