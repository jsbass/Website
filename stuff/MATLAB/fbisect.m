function [root,fval,err,iter] = fbisect(func,xl,xu,err_min,varargin)
% fbisect: bisection root locator
%   [root,fval,err,iter] = fbisect(func,x1,xu,err_min,max_iter,fargin):
